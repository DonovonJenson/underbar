(function() {
  ...
  _.reject = function(collection, test) {
    ...
    _.each(collection,function(checker){
      if (passed.includes(checker) === false){
        result.push(checker);
      }
    })
    return result;
...
if (iterator === undefined){
  return _.reduce(collection, function(truth,value){
    value = Boolean(value);
    if (value === false){
      return false;
    }
